...
export function InteractiveCard() {
  return (
    <main className="relative mx-auto flex min-h-screen w-full max-w-[430px] items-center justify-center px-4 py-8 text-foreground sm:px-5">
      ...
      >
        ...
        <section className="relative overflow-hidden rounded-[26px] border border-white/8 bg-black/40 px-4 py-5">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="float-soft relative h-16 w-16 overflow-hidden rounded-[22px] border border-white/10 bg-gradient-to-br from-[#2a060d] via-[#120507] to-[#070707] p-1 shadow-[0_0_0_1px_rgba(216,20,44,0.12),0_14px_30px_rgba(0,0,0,0.4)]">
                <div className="relative h-full w-full overflow-hidden rounded-[18px] bg-[#12070a]">
                  <Image
                    src="/sos-mark.svg"
                    alt="Ambientação premium da S.O.S Narguilé"
                    fill
                    sizes="64px"
                    className="object-cover opacity-70"
                    priority
                  />
                  <div className="absolute inset-0 bg-gradient-to-br from-red/20 via-transparent to-black/30" />
                  <div className="absolute inset-0 flex items-center justify-center text-lg font-black tracking-[0.25em] text-white">
                    SOS
                  </div>
                </div>
              </div>
              ...
              <div className="min-w-0">
                <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-red/20 bg-red/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.24em] text-white/85">
                ...
                <p className="mt-2 max-w-[220px] text-sm leading-5 text-white/72">
                  Presença forte, atendimento rápido e identidade marcante.
                </p>
              </div>
            </div>
            ...
            <Link
              ...
              target="_blank"
              className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-white/80 transition hover:border-red/30 hover:bg-red/10 hover:text-white"
        ...
        <motion.section
          ...
          className="relative mt-4 overflow-hidden rounded-[24px] border border-red/15 bg-gradient-to-br from-red/16 via-red/7 to-white/[0.03] px-4 py-4"
        >
          ...
          <div className="relative flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-5 text-white/72">
                Um cartão institucional criado para reforçar praticidade, reputação e a identidade marcante da marca em cada toque.
              </p>
            </div>
          </div>
        </motion.section>
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group glass-panel neon-edge relative flex overflow-hidden rounded-[24px] border border-white/10 px-4 py-4 transition duration-300 active:scale-[0.985]"
                >
                  ...
                  <div className="mr-3 flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-red/15 bg-gradient-to-br from-red/18 via-black/40 to-white/[0.03] text-red-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
                    <Icon className="h-5 w-5" />
                  </div>

                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between gap-3">
                      <span className="inline-flex rounded-full border border-white/10 bg-white/[0.04] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-white/70">
                        {item.label}
                      </span>
                    ...
                    <p className="mt-1 text-sm leading-5 text-white/68">{item.subtitle}</p>
        ...
        <section className="mt-4 grid gap-3 sm:grid-cols-2">
          <motion.article
            ...
            className="glass-panel rounded-[24px] border border-white/10 px-4 py-4"
          >
            <span className="inline-flex rounded-full border border-white/10 bg-white/[0.04] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-white/70">
              Atualizado
            </span>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/72">
              <li className="flex items-center justify-between gap-2 rounded-2xl bg-white/[0.03] px-3 py-2">
          ...
          >
            ...
            <div className="mt-3 flex items-end gap-2">
              <strong className="text-3xl font-black tracking-[-0.04em] text-white">4,8</strong>
              <span className="pb-1 text-sm text-white/55">reputação local</span>
            </div>
            <div className="mt-3 flex gap-1 text-red-200">
              {Array.from({ length: 5 }).map((_, index) => (
                <Star key={index} className={`h-4 w-4 ${index === 4 ? 'opacity-50' : ''}`} fill="currentColor" />
              ))}
            </div>
            <p className="mt-3 text-sm leading-5 text-white/72">
              Elogios recorrentes sobre variedade, preços competitivos e um atendimento que transmite confiança no dia a dia.
            </p>
          </motion.article>
        </section>
